                        ...
                        <form action="{{ route('categorias.update', $categoria->id) }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                                <div class="grid grid-cols-1">
                                    ...
                                    <input name="nombre" value="{{ $categoria->nombre }}" class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text" required />
                                </div>
                            </div>
