...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Hojas de Seguridad</h3>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                            ...
                            <table id="hojas" class="table table-striped table-hover" style="width: 100%;">
                                <thead>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Nueva Hoja</h5>
...
<form enctype="multipart/form-data" class="modal fade" id="exampleModalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Editar Hoja</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="hidden" id="hojas_id" name="hojas_id">
                    <input type="hidden" id="hojas_code" name="hojas_code">
                </div>
                <div class="form-group">
