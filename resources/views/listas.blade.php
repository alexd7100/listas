...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Precios Exterior</h3>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                            ...
                            <table id="listas" class="table table-striped table-hover" style="width: 100%;">
                                <thead>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <div class="flex justify-center rounded-lg text-lg" role="group">
                                            <td width="40%">
                                                ...
                                                @can('editar-listas')
                                                <button type="button" class="rounded bg-blue-400 hover:bg-gray-500 text-white font-bold py-2 px-4" onclick="modalEdit('{{ $item->id }}','{{ $item->title }}','{{ $item->reference }}','{{ $item->state }}','{{ $item->listas_code }}')" data-toggle="modal" data-target="#exampleModalEdit">Editar</button>
                                                @endcan 
...
<form enctype="multipart/form-data" class="modal fade" id="exampleModalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Editar Lista de Precio</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="hidden" id="listas_id" name="listas_id">
                    <input type="hidden" id="listas_code" name="listas_code">
                </div>
                <div class="form-group">
